...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <h1>Commandes</h1>
            <p style="color:white">Voir vos commandes</p>
    ...
    <div class="order-section">
        <div class="box-container">
            ...
            ?>
            <div class="box">
                <p>placée: <span><?php echo $fetch_orders['placed_on']; ?></span></p>
                ...
                <p>methode de payement: <span><?php echo $fetch_orders['method']; ?></span></p>
                ...
                <p>statut de payement: <span><?php echo $fetch_orders['payment_status']; ?></span></p>
            </div>
            <?php
                    }
                }else{
                        echo '
                            <div class="empty">
                                <p>aucune commande à été passée !</p>
                            </div>
                        ';
                }
            ?>
