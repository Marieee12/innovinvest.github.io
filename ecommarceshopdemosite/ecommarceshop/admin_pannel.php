	...
	<section class="dashboard">
		<div class="box-container">
			<div class="box">
				...
				<p>total des commandes en cours</p>
			</div>
			<div class="box">
				<?php 
					$total_completes = 0;
				...
				?>
				<h3><?php echo $total_completes; ?>fcfa</h3>
				<p>Total des achèvements</p>
			</div>
			<div class="box">
				<?php 
			...
			<div class="box">
				...
				<p>total des utilisateurs normaux</p>
			</div>
			<div class="box">
				<?php 
			...
			<div class="box">
				...
				?>
				<h3><?php echo $num_of_users; ?></h3>
				<p>total des utilisateurs enregistrés</p>
			</div>
			<div class="box">
				<?php 
